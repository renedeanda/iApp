...
enum DataDeletionService {
    ...
    /// Shared with SproutWidgets/WidgetSharedData.swift — same marker name,
    ...
    private static let cloudKitContainerIdentifier = "iCloud.com.example.sprout"
    ...
    private static let appGroupIdentifier = "group.com.example.sprout"
    ...
    private static func clearWidgetSnapshots() {
        ...
        // Matches SproutWidgets/WidgetSharedData.swift's fileName.
        let knownFiles = [
            "widget-data.json",
