...
3. Skim `DECISIONS/004-native-feature-checklist.md` — which services are still in `Sprout/Services/_Disabled/`?
...
6. Print:
   ...
   - **Blocked / waiting** (anything in `// TODO(...)` markers or pending ADRs)
   - **Quick suggestions** — usually a slash command (`/build`, `/test`, `/translate <lang>`)
