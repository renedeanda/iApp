...
//
// `SproutActivityAttributes` lives in its own file (SproutActivityAttributes.swift)
...
struct SproutLiveActivity: Widget {
    var body: some WidgetConfiguration {
        ActivityConfiguration(for: SproutActivityAttributes.self) { context in
    ...
    @ViewBuilder
    private func lockScreen(context: ActivityViewContext<SproutActivityAttributes>) -> some View {
