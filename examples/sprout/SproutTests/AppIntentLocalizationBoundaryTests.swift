...
struct AppIntentLocalizationBoundaryTests {
    ...
    func intentKeysAreCompiled() throws {
        ...
        let intentsRoot = root.appendingPathComponent("Sprout/Intents")
        ...
        let data = try Data(
            contentsOf: root.appendingPathComponent("Sprout/Localizable.xcstrings")
        )
    ...
    func shortcutPhrasesHaveApplicationNameToken() throws {
        let providerURL = repositoryRoot.appendingPathComponent(
            "Sprout/Intents/SproutShortcutsProvider.swift"
        )
