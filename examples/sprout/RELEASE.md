# Sprout Release Context

> Repo-local context for release agents and humans preparing an App Store submission.
> The wizard substitutes Sprout tokens at `/new-app --commit`; keep this file current
> after major changes.

## Release Identity

- Bundle ID: `com.example.sprout`
- Platforms: iOS
- Shipping branch: `main`
- Metadata: `Marketing/AppStoreMetadata/sprout-app-store-metadata.json`
