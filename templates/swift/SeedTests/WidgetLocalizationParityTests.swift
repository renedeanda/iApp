...
struct WidgetLocalizationParityTests {
    @Test func widgetCatalogCoversWidgetStrings() throws {
        ...
        #expect(project.contains("path: SeedWidgets/Resources/Localizable.xcstrings"))
        #expect(project.contains("path: SeedWidgets/PrivacyInfo.xcprivacy"))
    }
    ...
    private func widgetCatalogURL() -> URL {
        ...
        return testFile
            .deletingLastPathComponent()
            .deletingLastPathComponent()
            .appendingPathComponent("SeedWidgets/Resources/Localizable.xcstrings")
    }
