...
| Privacy | data collection or required-reason API | privacy manifests, SDK inventory, permission strings, the repo's privacy plan | ASC label matches actual flows; consent and minimization |
