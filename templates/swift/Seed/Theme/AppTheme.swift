...
/// The Seed template's palette tokens.
///
...
enum AppTheme {
    ...
    static let surfaceTertiary  = dynamic(light: 0xE8DEC9, dark: 0x342B20)
    ...
    // Accent — warm copper. The accent brightens in dark so it carries
