...
//
//   1. Uncomment the SeedWidgets app-extension target in project.yml.
//   2. Add this single file to the Seed app target's sources:
//
//      targets:
//        Seed:
//          sources:
//            - path: Seed
//              excludes: ...
//            - path: SeedWidgets/SeedActivityAttributes.swift  # ← add this
//
//   3. Add `NSSupportsLiveActivities = YES` to Seed/Info.plist's
...
struct SeedActivityAttributes: ActivityAttributes {
