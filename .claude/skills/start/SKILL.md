...
3. **Route.**
   ...
   **Idea-ready →** Give a two-sentence preview of the deal ("21 design questions before any tech choice; you sleep on it before code renders — that's deliberate") then hand off to [`/new-app --draft`](../new-app/SKILL.md). Do not pre-answer any wizard question for them.
